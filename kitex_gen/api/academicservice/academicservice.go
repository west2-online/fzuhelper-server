...
func getCreditV2Handler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*api.AcademicServiceGetCreditV2Args)
	realResult := result.(*api.AcademicServiceGetCreditV2Result)
	success, err := handler.(api.AcademicService).GetCreditV2(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newAcademicServiceGetCreditV2Args() interface{} {
	return api.NewAcademicServiceGetCreditV2Args()
}

func newAcademicServiceGetCreditV2Result() interface{} {
	return api.NewAcademicServiceGetCreditV2Result()
}
...
func (p *kClient) GetCreditV2(ctx context.Context, req *api.GetCreditV2Request) (r *api.GetCreditV2Response, err error) {
	var _args api.AcademicServiceGetCreditV2Args
	_args.Req = req
	var _result api.AcademicServiceGetCreditV2Result
