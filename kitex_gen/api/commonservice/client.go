...
type Client interface {
	...
	GetToolboxConfigList(ctx context.Context, req *api.GetToolboxConfigListRequest, callOptions ...callopt.Option) (r *api.GetToolboxConfigListResponse, err error)
	...
	GetSignedLocationApiUrl(ctx context.Context, req *api.GetSignedLocationApiUrlRequest, callOptions ...callopt.Option) (r *api.GetSignedLocationApiUrlResponse, err error)
}
...
func (p *kCommonServiceClient) GetToolboxConfigList(ctx context.Context, req *api.GetToolboxConfigListRequest, callOptions ...callopt.Option) (r *api.GetToolboxConfigListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
...
func (p *kCommonServiceClient) GetSignedLocationApiUrl(ctx context.Context, req *api.GetSignedLocationApiUrlRequest, callOptions ...callopt.Option) (r *api.GetSignedLocationApiUrlResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
