...
func getToolboxConfigListHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*api.CommonServiceGetToolboxConfigListArgs)
	realResult := result.(*api.CommonServiceGetToolboxConfigListResult)
	success, err := handler.(api.CommonService).GetToolboxConfigList(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newCommonServiceGetToolboxConfigListArgs() interface{} {
	return api.NewCommonServiceGetToolboxConfigListArgs()
}

func newCommonServiceGetToolboxConfigListResult() interface{} {
	return api.NewCommonServiceGetToolboxConfigListResult()
}
...
func getSignedLocationApiUrlHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*api.CommonServiceGetSignedLocationApiUrlArgs)
	realResult := result.(*api.CommonServiceGetSignedLocationApiUrlResult)
	success, err := handler.(api.CommonService).GetSignedLocationApiUrl(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newCommonServiceGetSignedLocationApiUrlArgs() interface{} {
	return api.NewCommonServiceGetSignedLocationApiUrlArgs()
}

func newCommonServiceGetSignedLocationApiUrlResult() interface{} {
	return api.NewCommonServiceGetSignedLocationApiUrlResult()
}
...
func (p *kClient) GetToolboxConfigList(ctx context.Context, req *api.GetToolboxConfigListRequest) (r *api.GetToolboxConfigListResponse, err error) {
	var _args api.CommonServiceGetToolboxConfigListArgs
	_args.Req = req
	var _result api.CommonServiceGetToolboxConfigListResult
...
func (p *kClient) GetSignedLocationApiUrl(ctx context.Context, req *api.GetSignedLocationApiUrlRequest) (r *api.GetSignedLocationApiUrlResponse, err error) {
	var _args api.CommonServiceGetSignedLocationApiUrlArgs
	_args.Req = req
	var _result api.CommonServiceGetSignedLocationApiUrlResult
