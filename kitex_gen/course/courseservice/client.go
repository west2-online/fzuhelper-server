...
func (p *kCourseServiceClient) GetAutoAdjustCourseList(ctx context.Context, req *course.GetAutoAdjustCourseListRequest, callOptions ...callopt.Option) (r *course.GetAutoAdjustCourseListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
...
func (p *kCourseServiceClient) UpsertCustomCourse(ctx context.Context, req *course.UpsertCustomCourseRequest, callOptions ...callopt.Option) (r *course.UpsertCustomCourseResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UpsertCustomCourse(ctx, req)
}

func (p *kCourseServiceClient) DeleteCustomCourse(ctx context.Context, req *course.DeleteCustomCourseRequest, callOptions ...callopt.Option) (r *course.DeleteCustomCourseResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.DeleteCustomCourse(ctx, req)
}
