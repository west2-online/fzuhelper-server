...
type GetScoresResponse struct {
	...
	Scores []*model.Score  `thrift:"scores,2,required" frugal:"2,required,list<model.Score>" json:"scores"`
}
...
type GetGPAResponse struct {
	Base *model.BaseResp `thrift:"base,1,required" frugal:"1,required,model.BaseResp" json:"base"`
	Gpa  *model.GPABean  `thrift:"gpa,2,required" frugal:"2,required,model.GPABean" json:"gpa"`
}
...
type GetCreditResponse struct {
	Base  *model.BaseResp `thrift:"base,1,required" frugal:"1,required,model.BaseResp" json:"base"`
	Major []*model.Credit `thrift:"major,2,required" frugal:"2,required,list<model.Credit>" json:"major"`
}
...
type GetUnifiedExamResponse struct {
	Base        *model.BaseResp      `thrift:"base,1,required" frugal:"1,required,model.BaseResp" json:"base"`
	UnifiedExam []*model.UnifiedExam `thrift:"unifiedExam,2,required" frugal:"2,required,list<model.UnifiedExam>" json:"unifiedExam"`
}
