...
type Client interface {
	...
	GetImage(ctx context.Context, req *launch_screen.GetImageRequest, callOptions ...callopt.Option) (r *launch_screen.GetImagesByUserIdResponse, err error)
...
func (p *kLaunchScreenServiceClient) GetImage(ctx context.Context, req *launch_screen.GetImageRequest, callOptions ...callopt.Option) (r *launch_screen.GetImagesByUserIdResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
