...
func (p *CreateImageRequest) GetSuffix() (v string) {
	return p.Suffix
}
...
func (p *CreateImageRequest) SetSuffix(val string) {
	p.Suffix = val
}
...
func (p *CreateImageRequest) writeField14(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("suffix", thrift.STRING, 14); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *CreateImageRequest) DeepEqual(ano *CreateImageRequest) bool {
	...
	if !p.Field14DeepEqual(ano.Suffix) {
		return false
	}
	return true
}
...
type ChangeImageRequest struct {
	...
	Suffix      string `thrift:"suffix,4" frugal:"4,default,string" json:"suffix"`
}
...
func (p *ChangeImageRequest) GetSuffix() (v string) {
	return p.Suffix
}
...
func (p *ChangeImageRequest) SetSuffix(val string) {
	p.Suffix = val
}
...
func (p *ChangeImageRequest) ReadField4(iprot thrift.TProtocol) error {
...
func (p *ChangeImageRequest) writeField4(oprot thrift.TProtocol) (err error) {
...
func (p *ChangeImageRequest) DeepEqual(ano *ChangeImageRequest) bool {
	...
	if !p.Field4DeepEqual(ano.Suffix) {
		return false
	}
	return true
}
...
func (p *ChangeImageRequest) Field4DeepEqual(src string) bool {
