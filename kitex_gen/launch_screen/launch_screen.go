...
type CreateImageRequest struct {
	...
	BufferCount int64   `thrift:"buffer_count,15" frugal:"15,default,i64" json:"buffer_count"`
}
...
func (p *CreateImageRequest) ReadField15(iprot thrift.TProtocol) error {
...
func (p *CreateImageRequest) writeField15(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("buffer_count", thrift.I64, 15); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *CreateImageRequest) DeepEqual(ano *CreateImageRequest) bool {
	...
	if !p.Field15DeepEqual(ano.BufferCount) {
		return false
	}
	return true
}
...
func (p *CreateImageRequest) Field15DeepEqual(src int64) bool {
...
func (p *LaunchScreenServiceClient) CreateImage(stream LaunchScreenService_CreateImageServer) (err error) {
	panic("streaming method LaunchScreenService.CreateImage(mode = client) not available, please use Kitex Thrift Streaming Client.")
}
...
func (p *LaunchScreenServiceClient) ChangeImage(stream LaunchScreenService_ChangeImageServer) (err error) {
	panic("streaming method LaunchScreenService.ChangeImage(mode = client) not available, please use Kitex Thrift Streaming Client.")
}
