...
type CreateImageRequest struct {
	...
	Regex      string  `thrift:"regex,14,required" frugal:"14,required,string" json:"regex"`
}
...
func (p *CreateImageRequest) writeField14(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("regex", thrift.STRING, 14); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *CreateImageRequest) DeepEqual(ano *CreateImageRequest) bool {
	...
	if !p.Field14DeepEqual(ano.Regex) {
		return false
	}
	return true
}
