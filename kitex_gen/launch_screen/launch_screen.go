...
func (p *GetImagesByUserIdResponse) DeepEqual(ano *GetImagesByUserIdResponse) bool {
	...
	if !p.Field2DeepEqual(ano.PictureList) {
		return false
	}
	return true
}
...
func (p *GetImagesByUserIdResponse) Field2DeepEqual(src []*model.Picture) bool {
...
func (p *LaunchScreenServiceGetImageResult) Field0DeepEqual(src *GetImagesByUserIdResponse) bool {
