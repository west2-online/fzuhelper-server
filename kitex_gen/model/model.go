...
type UpYunFileDir struct {
	...
	Files    []string `thrift:"files,2,optional" frugal:"2,optional,list<string>" json:"files,omitempty"`
	Folders  []string `thrift:"folders,3,optional" frugal:"3,optional,list<string>" json:"folders,omitempty"`
}
