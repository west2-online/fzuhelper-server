...
type Picture struct {
	...
	PicType    int64  `thrift:"pic_type,6" frugal:"6,default,i64" json:"pic_type"`
	...
	StuId      int64  `thrift:"stu_id,16" frugal:"16,default,i64" json:"stu_id"`
...
func (p *Picture) SetPicType(val int64) {
	p.PicType = val
}
...
func (p *Picture) SetStuId(val int64) {
	p.StuId = val
}
...
func (p *Picture) DeepEqual(ano *Picture) bool {
	...
	if !p.Field6DeepEqual(ano.PicType) {
		return false
	}
	...
	if !p.Field16DeepEqual(ano.StuId) {
		return false
	}
