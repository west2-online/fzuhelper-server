...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"UploadFeedbackScreenshot": kitex.NewMethodInfo(
		uploadFeedbackScreenshotHandler,
		newOAServiceUploadFeedbackScreenshotArgs,
		newOAServiceUploadFeedbackScreenshotResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"UploadFeedbackLog": kitex.NewMethodInfo(
		uploadFeedbackLogHandler,
		newOAServiceUploadFeedbackLogArgs,
		newOAServiceUploadFeedbackLogResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
...
func uploadFeedbackScreenshotHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*oa.OAServiceUploadFeedbackScreenshotArgs)
	realResult := result.(*oa.OAServiceUploadFeedbackScreenshotResult)
	success, err := handler.(oa.OAService).UploadFeedbackScreenshot(ctx, realArg.Request)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newOAServiceUploadFeedbackScreenshotArgs() interface{} {
	return oa.NewOAServiceUploadFeedbackScreenshotArgs()
}

func newOAServiceUploadFeedbackScreenshotResult() interface{} {
	return oa.NewOAServiceUploadFeedbackScreenshotResult()
}

func uploadFeedbackLogHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*oa.OAServiceUploadFeedbackLogArgs)
	realResult := result.(*oa.OAServiceUploadFeedbackLogResult)
	success, err := handler.(oa.OAService).UploadFeedbackLog(ctx, realArg.Request)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newOAServiceUploadFeedbackLogArgs() interface{} {
	return oa.NewOAServiceUploadFeedbackLogArgs()
}

func newOAServiceUploadFeedbackLogResult() interface{} {
	return oa.NewOAServiceUploadFeedbackLogResult()
}
...
func (p *kClient) UploadFeedbackScreenshot(ctx context.Context, request *oa.UploadFeedbackScreenshotRequest) (r *oa.UploadFeedbackScreenshotResponse, err error) {
	var _args oa.OAServiceUploadFeedbackScreenshotArgs
	_args.Request = request
	var _result oa.OAServiceUploadFeedbackScreenshotResult
	if err = p.c.Call(ctx, "UploadFeedbackScreenshot", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) UploadFeedbackLog(ctx context.Context, request *oa.UploadFeedbackLogRequest) (r *oa.UploadFeedbackLogResponse, err error) {
	var _args oa.OAServiceUploadFeedbackLogArgs
	_args.Request = request
	var _result oa.OAServiceUploadFeedbackLogResult
	if err = p.c.Call(ctx, "UploadFeedbackLog", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) GetFeedbackById(ctx context.Context, request *oa.GetFeedbackByIDRequest) (r *oa.GetFeedbackByIDResponse, err error) {
