...
func putToolboxConfigHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(common.CommonService).PutToolboxConfig(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newCommonServicePutToolboxConfigArgs() interface{} {
	return common.NewCommonServicePutToolboxConfigArgs()
}

func newCommonServicePutToolboxConfigResult() interface{} {
	return common.NewCommonServicePutToolboxConfigResult()
}
...
func (p *kClient) PutToolboxConfig(ctx context.Context, req *common.PutToolboxConfigRequest) (r *common.PutToolboxConfigResponse, err error) {
	var _args common.CommonServicePutToolboxConfigArgs
	_args.Req = req
	var _result common.CommonServicePutToolboxConfigResult
