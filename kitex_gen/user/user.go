...
type RegisterRequest struct {
	Number   string `thrift:"number,1,required" frugal:"1,required,string" json:"number"`
	Password string `thrift:"password,2,required" frugal:"2,required,string" json:"password"`
}
...
func (p *RegisterRequest) SetNumber(val string) {
	p.Number = val
}
...
type LoginRequest struct {
	Number   string `thrift:"number,1" frugal:"1,default,string" json:"number"`
...
func (p *LoginRequest) SetNumber(val string) {
	p.Number = val
}
