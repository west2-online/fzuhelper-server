...
type Client interface {
	UploadFile(ctx context.Context, req *paper.UploadFileRequest, callOptions ...callopt.Option) (r *paper.UploadFileResponse, err error)
...
func (p *kPaperServiceClient) UploadFile(ctx context.Context, req *paper.UploadFileRequest, callOptions ...callopt.Option) (r *paper.UploadFileResponse, err error) {
