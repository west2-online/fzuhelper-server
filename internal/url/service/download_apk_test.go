...
func TestDownloadBetaApk(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			...
			expectedUrl:       "",
			expectingError:    true,
			expectedErrorInfo: "UrlService.DownloadBetaApk error:file not found",
		},
		{
			name:              "UnmarshalError",
			...
			expectedUrl:       "",
			expectingError:    true,
			expectedErrorInfo: `UrlService.DownloadBetaApk error:"Syntax error at index 1: invalid char\n\n\tinvalid json\n\t.^..........\n"`,
		},
	}
...
func TestDownloadReleaseApk(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			...
			expectedUrl:       "",
			expectingError:    true,
			expectedErrorInfo: "UrlService.DownloadReleaseApk error:file not found",
		},
		{
			name:              "UnmarshalError",
			mockJsonBytes:     []byte(`invalid json`),
			...
			expectedUrl:       "",
			expectingError:    true,
			expectedErrorInfo: `UrlService.DownloadReleaseApk error:"Syntax error at index 1: invalid char\n\n\tinvalid json\n\t.^..........\n"`,
		},
	}
