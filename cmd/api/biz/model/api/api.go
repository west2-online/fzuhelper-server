...
type UserService interface {
	...
	GetValidateCode(ctx context.Context, request *GetValidateCodeRequest) (r *GetValidateCodeResponse, err error)
}
...
func (p *UserServiceClient) GetValidateCode(ctx context.Context, request *GetValidateCodeRequest) (r *GetValidateCodeResponse, err error) {
...
func (p *userServiceProcessorGetValidateCode) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	if retval, err2 = p.handler.GetValidateCode(ctx, args.Request); err2 != nil {
...
type UserServiceGetValidateCodeArgs struct {
	Request *GetValidateCodeRequest `thrift:"request,1"`
}
...
var UserServiceGetValidateCodeArgs_Request_DEFAULT *GetValidateCodeRequest

func (p *UserServiceGetValidateCodeArgs) GetRequest() (v *GetValidateCodeRequest) {
	if !p.IsSetRequest() {
		return UserServiceGetValidateCodeArgs_Request_DEFAULT
	}
	return p.Request
}
...
type UserServiceGetValidateCodeResult struct {
	Success *GetValidateCodeResponse `thrift:"success,0,optional"`
}
