...
type EmptyClassroomResponse struct {
	Classrooms []*Classroom `thrift:"classrooms,1,required" form:"classrooms,required" json:"classrooms,required" query:"classrooms,required"`
}
...
func (p *EmptyClassroomResponse) GetClassrooms() (v []*Classroom) {
	return p.Classrooms
}
