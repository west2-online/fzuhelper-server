...
type RegisterRequest struct {
	Number   string `thrift:"number,1,required" form:"number,required" json:"number,required" query:"number,required"`
	Password string `thrift:"password,2,required" form:"password,required" json:"password,required" query:"password,required"`
}
...
func (p *RegisterRequest) GetNumber() (v string) {
	return p.Number
}
...
type LoginRequest struct {
	Number   string `thrift:"number,1" form:"number" json:"number" query:"number"`
...
func (p *LoginRequest) GetNumber() (v string) {
	return p.Number
}
...
type CreateImageRequest struct {
	...
	StuID      int64  `thrift:"stu_id,12,required" form:"stu_id,required" json:"stu_id,required" query:"stu_id,required"`
	DeviceType int64  `thrift:"device_type,13,required" form:"device_type,required" json:"device_type,required" query:"device_type,required"`
	//get by token
	UserID int64 `thrift:"user_id,14" form:"user_id" json:"user_id" query:"user_id"`
}
...
func (p *CreateImageRequest) writeField14(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("user_id", thrift.I64, 14); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI64(p.UserID); err != nil {
		return err
...
type GetImagesByUserIdRequest struct {
	StuID int64 `thrift:"stu_id,1,required" form:"stu_id,required" json:"stu_id,required" query:"stu_id,required"`
}
...
type DeleteImageRequest struct {
	PictureID int64 `thrift:"picture_id,1,required" form:"picture_id,required" json:"picture_id,required" query:"picture_id,required"`
	StuID     int64 `thrift:"stu_id,2,required" form:"stu_id,required" json:"stu_id,required" query:"stu_id,required"`
}
...
type MobileGetImageRequest struct {
	SType      int64 `thrift:"s_type,1,required" form:"s_type,required" json:"s_type,required" query:"s_type,required"`
	StuID      int64 `thrift:"stu_id,2,required" form:"stu_id,required" json:"stu_id,required" query:"stu_id,required"`
	DeviceType int64 `thrift:"device_type,3,required" form:"device_type,required" json:"device_type,required" query:"device_type,required"`
}
