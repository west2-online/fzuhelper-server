...
type Picture struct {
	...
	StuID      int64  `thrift:"stu_id,16" form:"stu_id" json:"stu_id" query:"stu_id"`
	DeviceType int64  `thrift:"device_type,17" form:"device_type" json:"device_type" query:"device_type"`
}
...
func (p *Picture) GetStuID() (v int64) {
	return p.StuID
}
...
func (p *Picture) writeField16(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("stu_id", thrift.I64, 16); err != nil {
		goto WriteFieldBeginError
	}
