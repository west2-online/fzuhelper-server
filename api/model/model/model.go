...
// 校历
type Term struct {
	TermID     string `thrift:"term_id,1,required" form:"term_id,required" json:"term_id,required" query:"term_id,required"`
	SchoolYear string `thrift:"school_year,2,required" form:"school_year,required" json:"school_year,required" query:"school_year,required"`
	Term       string `thrift:"term,3,required" form:"term,required" json:"term,required" query:"term,required"`
	StartDate  string `thrift:"start_date,4,required" form:"start_date,required" json:"start_date,required" query:"start_date,required"`
	EndDate    string `thrift:"end_date,5,required" form:"end_date,required" json:"end_date,required" query:"end_date,required"`
}
...
type TermEvent struct {
	Name      string `thrift:"name,1,required" form:"name,required" json:"name,required" query:"name,required"`
	StartDate string `thrift:"start_date,2,required" form:"start_date,required" json:"start_date,required" query:"start_date,required"`
	EndDate   string `thrift:"end_date,3,required" form:"end_date,required" json:"end_date,required" query:"end_date,required"`
}
