...
type CourseListV2 struct {
	Courses       []*Course       `thrift:"courses,1,required,list<Course>" form:"courses,required" json:"courses,required" query:"courses,required"`
	CustomCourses []*CustomCourse `thrift:"custom_courses,2,required,list<CustomCourse>" form:"custom_courses,required" json:"custom_courses,required" query:"custom_courses,required"`
}
...
func NewToolboxConfigDetail() *ToolboxConfigDetail {
	return &ToolboxConfigDetail{}
}

func (p *ToolboxConfigDetail) InitDefault() {
}

func (p *ToolboxConfigDetail) GetConfigID() (v int64) {
	return p.ConfigID
}

func (p *ToolboxConfigDetail) GetToolID() (v int64) {
	return p.ToolID
}

func (p *ToolboxConfigDetail) GetVisible() (v bool) {
	return p.Visible
}
...
func (p *ToolboxConfigDetail) String() string {
	...
	return fmt.Sprintf("ToolboxConfigDetail(%+v)", *p)
}
