...
func (p *UrlServiceClient) HelloWorld(ctx context.Context, req *HelloWorldRequest) (r *HelloWroldResponse, err error) {
	var _args UrlServiceHelloWorldArgs
	_args.Req = req
	var _result UrlServiceHelloWorldResult
...
func NewUrlServiceProcessor(handler UrlService) *UrlServiceProcessor {
	...
	self.AddToProcessorMap("HelloWorld", &urlServiceProcessorHelloWorld{handler: handler})
...
type urlServiceProcessorHelloWorld struct {
	handler UrlService
}

func (p *urlServiceProcessorHelloWorld) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := UrlServiceHelloWorldArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := UrlServiceHelloWorldResult{}
...
type UrlServiceHelloWorldArgs struct {
	Req *HelloWorldRequest `thrift:"req,1"`
}

func NewUrlServiceHelloWorldArgs() *UrlServiceHelloWorldArgs {
	return &UrlServiceHelloWorldArgs{}
}

func (p *UrlServiceHelloWorldArgs) InitDefault() {
}

var UrlServiceHelloWorldArgs_Req_DEFAULT *HelloWorldRequest

func (p *UrlServiceHelloWorldArgs) GetReq() (v *HelloWorldRequest) {
	if !p.IsSetReq() {
		return UrlServiceHelloWorldArgs_Req_DEFAULT
	}
	return p.Req
}

var fieldIDToName_UrlServiceHelloWorldArgs = map[int16]string{
	1: "req",
}

func (p *UrlServiceHelloWorldArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *UrlServiceHelloWorldArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UrlServiceHelloWorldArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UrlServiceHelloWorldArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *UrlServiceHelloWorldArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *UrlServiceHelloWorldArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *UrlServiceHelloWorldArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UrlServiceHelloWorldArgs(%+v)", *p)

}

type UrlServiceHelloWorldResult struct {
	Success *HelloWroldResponse `thrift:"success,0,optional"`
}

func NewUrlServiceHelloWorldResult() *UrlServiceHelloWorldResult {
	return &UrlServiceHelloWorldResult{}
}

func (p *UrlServiceHelloWorldResult) InitDefault() {
}

var UrlServiceHelloWorldResult_Success_DEFAULT *HelloWroldResponse

func (p *UrlServiceHelloWorldResult) GetSuccess() (v *HelloWroldResponse) {
	if !p.IsSetSuccess() {
		return UrlServiceHelloWorldResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_UrlServiceHelloWorldResult = map[int16]string{
	0: "success",
}

func (p *UrlServiceHelloWorldResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *UrlServiceHelloWorldResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UrlServiceHelloWorldResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UrlServiceHelloWorldResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *UrlServiceHelloWorldResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *UrlServiceHelloWorldResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *UrlServiceHelloWorldResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UrlServiceHelloWorldResult(%+v)", *p)
