...
func (p *GetLocateDateResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetLocateDate() {
		if err = oprot.WriteFieldBegin("locateDate", thrift.STRUCT, 1); err != nil {
			goto WriteFieldBeginError
		}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_GetPlanRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_GetPlanRequest[fieldId]))
}

func (p *GetPlanRequest) ReadField1(iprot thrift.TProtocol) error {
...
func (p *GetPlanRequest) ReadField2(iprot thrift.TProtocol) error {
...
func (p *GetPlanRequest) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("id", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.ID); err != nil {
...
func (p *GetPlanRequest) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("cookies", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Cookies); err != nil {
...
func (p *GetNoticeRequst) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_GetNoticeRequst[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_GetNoticeRequst[fieldId]))
}

func (p *GetNoticeRequst) ReadField1(iprot thrift.TProtocol) error {
...
func (p *GetNoticeRequst) Write(oprot thrift.TProtocol) (err error) {

	var fieldId int16
	if err = oprot.WriteStructBegin("GetNoticeRequst"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *GetNoticeRequst) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *GetNoticeResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_GetNoticeResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_GetNoticeResponse[fieldId]))
}

func (p *GetNoticeResponse) ReadField1(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *GetNoticeResponse) ReadField2(iprot thrift.TProtocol) error {
...
func (p *GetNoticeResponse) Write(oprot thrift.TProtocol) (err error) {

	var fieldId int16
	if err = oprot.WriteStructBegin("GetNoticeResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *GetNoticeResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("notices", thrift.LIST, 1); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *GetNoticeResponse) writeField2(oprot thrift.TProtocol) (err error) {
...
func (p *UserServiceClient) GetGetLoginDataForYJSY(ctx context.Context, request *GetLoginDataForYJSYRequest) (r *GetLoginDataForYJSYResponse, err error) {
	var _args UserServiceGetGetLoginDataForYJSYArgs
	_args.Request = request
	var _result UserServiceGetGetLoginDataForYJSYResult
	if err = p.Client_().Call(ctx, "GetGetLoginDataForYJSY", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func (p *CourseServiceClient) GetLocateDate(ctx context.Context, req *GetLocateDateRequest) (r *GetLocateDateResponse, err error) {
	var _args CourseServiceGetLocateDateArgs
	_args.Req = req
	var _result CourseServiceGetLocateDateResult
	if err = p.Client_().Call(ctx, "GetLocateDate", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func (p *AcademicServiceClient) GetPlan(ctx context.Context, req *GetPlanRequest) (r *GetPlanResponse, err error) {
...
func NewVersionServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *VersionServiceClient {
	return &VersionServiceClient{
		c: thrift.NewTStandardClient(f.GetProtocol(t), f.GetProtocol(t)),
	}
}

func NewVersionServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *VersionServiceClient {
	return &VersionServiceClient{
		c: thrift.NewTStandardClient(iprot, oprot),
	}
}

func NewVersionServiceClient(c thrift.TClient) *VersionServiceClient {
	return &VersionServiceClient{
		c: c,
	}
}

func (p *VersionServiceClient) Client_() thrift.TClient {
	return p.c
}

func (p *VersionServiceClient) Login(ctx context.Context, req *LoginRequest) (r *LoginResponse, err error) {
	var _args VersionServiceLoginArgs
	_args.Req = req
	var _result VersionServiceLoginResult
	if err = p.Client_().Call(ctx, "Login", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VersionServiceClient) UploadVersion(ctx context.Context, req *UploadRequest) (r *UploadResponse, err error) {
	var _args VersionServiceUploadVersionArgs
	_args.Req = req
	var _result VersionServiceUploadVersionResult
	if err = p.Client_().Call(ctx, "UploadVersion", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VersionServiceClient) UploadParams(ctx context.Context, req *UploadParamsRequest) (r *UploadParamsResponse, err error) {
	var _args VersionServiceUploadParamsArgs
	_args.Req = req
	var _result VersionServiceUploadParamsResult
	if err = p.Client_().Call(ctx, "UploadParams", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VersionServiceClient) DownloadReleaseApk(ctx context.Context, req *DownloadReleaseApkRequest) (r *DownloadReleaseApkResponse, err error) {
	var _args VersionServiceDownloadReleaseApkArgs
	_args.Req = req
	var _result VersionServiceDownloadReleaseApkResult
	if err = p.Client_().Call(ctx, "DownloadReleaseApk", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VersionServiceClient) DownloadBetaApk(ctx context.Context, req *DownloadBetaApkRequest) (r *DownloadBetaApkResponse, err error) {
	var _args VersionServiceDownloadBetaApkArgs
	_args.Req = req
	var _result VersionServiceDownloadBetaApkResult
	if err = p.Client_().Call(ctx, "DownloadBetaApk", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VersionServiceClient) GetReleaseVersion(ctx context.Context, req *GetReleaseVersionRequest) (r *GetReleaseVersionResponse, err error) {
	var _args VersionServiceGetReleaseVersionArgs
	_args.Req = req
	var _result VersionServiceGetReleaseVersionResult
	if err = p.Client_().Call(ctx, "GetReleaseVersion", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VersionServiceClient) GetBetaVersion(ctx context.Context, req *GetBetaVersionRequest) (r *GetBetaVersionResponse, err error) {
	var _args VersionServiceGetBetaVersionArgs
	_args.Req = req
	var _result VersionServiceGetBetaVersionResult
	if err = p.Client_().Call(ctx, "GetBetaVersion", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VersionServiceClient) GetSetting(ctx context.Context, req *GetSettingRequest) (r *GetSettingResponse, err error) {
	var _args VersionServiceGetSettingArgs
	_args.Req = req
	var _result VersionServiceGetSettingResult
	if err = p.Client_().Call(ctx, "GetSetting", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VersionServiceClient) GetTest(ctx context.Context, req *GetTestRequest) (r *GetTestResponse, err error) {
	var _args VersionServiceGetTestArgs
	_args.Req = req
	var _result VersionServiceGetTestResult
	if err = p.Client_().Call(ctx, "GetTest", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VersionServiceClient) GetCloud(ctx context.Context, req *GetCloudRequest) (r *GetCloudResponse, err error) {
	var _args VersionServiceGetCloudArgs
	_args.Req = req
	var _result VersionServiceGetCloudResult
	if err = p.Client_().Call(ctx, "GetCloud", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VersionServiceClient) SetCloud(ctx context.Context, req *SetCloudRequest) (r *SetCloudResponse, err error) {
	var _args VersionServiceSetCloudArgs
	_args.Req = req
	var _result VersionServiceSetCloudResult
	if err = p.Client_().Call(ctx, "SetCloud", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VersionServiceClient) GetDump(ctx context.Context, req *GetDumpRequest) (r *GetDumpResponse, err error) {
	var _args VersionServiceGetDumpArgs
	_args.Req = req
	var _result VersionServiceGetDumpResult
	if err = p.Client_().Call(ctx, "GetDump", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *VersionServiceClient) AndroidGetVersion(ctx context.Context, req *AndroidGetVersioneRequest) (r *AndroidGetVersionResponse, err error) {
	var _args VersionServiceAndroidGetVersionArgs
	_args.Req = req
	var _result VersionServiceAndroidGetVersionResult
	if err = p.Client_().Call(ctx, "AndroidGetVersion", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func (p *CommonServiceClient) GetCSS(ctx context.Context, req *GetCSSRequest) (r *GetCSSResponse, err error) {
	var _args CommonServiceGetCSSArgs
	_args.Req = req
	var _result CommonServiceGetCSSResult
	if err = p.Client_().Call(ctx, "GetCSS", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *CommonServiceClient) GetHtml(ctx context.Context, req *GetHtmlRequest) (r *GetHtmlResponse, err error) {
	var _args CommonServiceGetHtmlArgs
	_args.Req = req
	var _result CommonServiceGetHtmlResult
	if err = p.Client_().Call(ctx, "GetHtml", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *CommonServiceClient) GetUserAgreement(ctx context.Context, req *GetUserAgreementRequest) (r *GetUserAgreementResponse, err error) {
	var _args CommonServiceGetUserAgreementArgs
	_args.Req = req
	var _result CommonServiceGetUserAgreementResult
	if err = p.Client_().Call(ctx, "GetUserAgreement", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *CommonServiceClient) GetTermsList(ctx context.Context, req *TermListRequest) (r *TermListResponse, err error) {
	var _args CommonServiceGetTermsListArgs
	_args.Req = req
	var _result CommonServiceGetTermsListResult
	if err = p.Client_().Call(ctx, "GetTermsList", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *CommonServiceClient) GetTerm(ctx context.Context, req *TermRequest) (r *TermResponse, err error) {
	var _args CommonServiceGetTermArgs
	_args.Req = req
	var _result CommonServiceGetTermResult
	if err = p.Client_().Call(ctx, "GetTerm", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *CommonServiceClient) GetNotice(ctx context.Context, req *GetNoticeRequst) (r *GetNoticeResponse, err error) {
	var _args CommonServiceGetNoticeArgs
	_args.Req = req
	var _result CommonServiceGetNoticeResult
	if err = p.Client_().Call(ctx, "GetNotice", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewUserServiceProcessor(handler UserService) *UserServiceProcessor {
	...
	self.AddToProcessorMap("GetGetLoginDataForYJSY", &userServiceProcessorGetGetLoginDataForYJSY{handler: handler})
...
type userServiceProcessorGetGetLoginDataForYJSY struct {
	handler UserService
}

func (p *userServiceProcessorGetGetLoginDataForYJSY) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := UserServiceGetGetLoginDataForYJSYArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("GetGetLoginDataForYJSY", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := UserServiceGetGetLoginDataForYJSYResult{}
	var retval *GetLoginDataForYJSYResponse
	if retval, err2 = p.handler.GetGetLoginDataForYJSY(ctx, args.Request); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing GetGetLoginDataForYJSY: "+err2.Error())
		oprot.WriteMessageBegin("GetGetLoginDataForYJSY", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("GetGetLoginDataForYJSY", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type UserServiceGetGetLoginDataForYJSYArgs struct {
	Request *GetLoginDataForYJSYRequest `thrift:"request,1"`
}
...
type UserServiceGetGetLoginDataForYJSYResult struct {
	Success *GetLoginDataForYJSYResponse `thrift:"success,0,optional"`
}
...
type courseServiceProcessorGetCalendar struct {
	handler CourseService
}

func (p *courseServiceProcessorGetCalendar) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := CourseServiceGetCalendarArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
type courseServiceProcessorGetLocateDate struct {
	handler CourseService
}

func (p *courseServiceProcessorGetLocateDate) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := CourseServiceGetLocateDateArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("GetLocateDate", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := CourseServiceGetLocateDateResult{}
	var retval *GetLocateDateResponse
	if retval, err2 = p.handler.GetLocateDate(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing GetLocateDate: "+err2.Error())
		oprot.WriteMessageBegin("GetLocateDate", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("GetLocateDate", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type CourseServiceGetLocateDateArgs struct {
	Req *GetLocateDateRequest `thrift:"req,1"`
}
...
type CourseServiceGetLocateDateResult struct {
	Success *GetLocateDateResponse `thrift:"success,0,optional"`
}
...
type AcademicServiceGetPlanArgs struct {
	Req *GetPlanRequest `thrift:"req,1"`
}
...
type AcademicServiceGetPlanResult struct {
	Success *GetPlanResponse `thrift:"success,0,optional"`
}
...
func (p *VersionServiceProcessor) AddToProcessorMap(key string, processor thrift.TProcessorFunction) {
	p.processorMap[key] = processor
}

func (p *VersionServiceProcessor) GetProcessorFunction(key string) (processor thrift.TProcessorFunction, ok bool) {
	processor, ok = p.processorMap[key]
	return processor, ok
}

func (p *VersionServiceProcessor) ProcessorMap() map[string]thrift.TProcessorFunction {
	return p.processorMap
}

func NewVersionServiceProcessor(handler VersionService) *VersionServiceProcessor {
	self := &VersionServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self.AddToProcessorMap("Login", &versionServiceProcessorLogin{handler: handler})
	self.AddToProcessorMap("UploadVersion", &versionServiceProcessorUploadVersion{handler: handler})
	self.AddToProcessorMap("UploadParams", &versionServiceProcessorUploadParams{handler: handler})
	self.AddToProcessorMap("DownloadReleaseApk", &versionServiceProcessorDownloadReleaseApk{handler: handler})
	self.AddToProcessorMap("DownloadBetaApk", &versionServiceProcessorDownloadBetaApk{handler: handler})
	self.AddToProcessorMap("GetReleaseVersion", &versionServiceProcessorGetReleaseVersion{handler: handler})
	self.AddToProcessorMap("GetBetaVersion", &versionServiceProcessorGetBetaVersion{handler: handler})
	self.AddToProcessorMap("GetSetting", &versionServiceProcessorGetSetting{handler: handler})
	self.AddToProcessorMap("GetTest", &versionServiceProcessorGetTest{handler: handler})
	self.AddToProcessorMap("GetCloud", &versionServiceProcessorGetCloud{handler: handler})
	self.AddToProcessorMap("SetCloud", &versionServiceProcessorSetCloud{handler: handler})
	self.AddToProcessorMap("GetDump", &versionServiceProcessorGetDump{handler: handler})
	self.AddToProcessorMap("AndroidGetVersion", &versionServiceProcessorAndroidGetVersion{handler: handler})
	return self
}
func (p *VersionServiceProcessor) Process(ctx context.Context, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	name, _, seqId, err := iprot.ReadMessageBegin()
	if err != nil {
		return false, err
	}
...
type versionServiceProcessorLogin struct {
	handler VersionService
}

func (p *versionServiceProcessorLogin) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VersionServiceLoginArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VersionServiceLoginResult{}
...
type versionServiceProcessorUploadVersion struct {
	handler VersionService
}

func (p *versionServiceProcessorUploadVersion) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VersionServiceUploadVersionArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VersionServiceUploadVersionResult{}
...
type versionServiceProcessorUploadParams struct {
	handler VersionService
}

func (p *versionServiceProcessorUploadParams) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VersionServiceUploadParamsArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VersionServiceUploadParamsResult{}
...
type versionServiceProcessorDownloadReleaseApk struct {
	handler VersionService
}

func (p *versionServiceProcessorDownloadReleaseApk) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VersionServiceDownloadReleaseApkArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VersionServiceDownloadReleaseApkResult{}
...
type versionServiceProcessorDownloadBetaApk struct {
	handler VersionService
}

func (p *versionServiceProcessorDownloadBetaApk) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VersionServiceDownloadBetaApkArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VersionServiceDownloadBetaApkResult{}
...
type versionServiceProcessorGetReleaseVersion struct {
	handler VersionService
}

func (p *versionServiceProcessorGetReleaseVersion) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VersionServiceGetReleaseVersionArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VersionServiceGetReleaseVersionResult{}
...
type versionServiceProcessorGetBetaVersion struct {
	handler VersionService
}

func (p *versionServiceProcessorGetBetaVersion) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VersionServiceGetBetaVersionArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VersionServiceGetBetaVersionResult{}
...
type versionServiceProcessorGetSetting struct {
	handler VersionService
}

func (p *versionServiceProcessorGetSetting) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VersionServiceGetSettingArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VersionServiceGetSettingResult{}
...
type versionServiceProcessorGetTest struct {
	handler VersionService
}

func (p *versionServiceProcessorGetTest) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VersionServiceGetTestArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VersionServiceGetTestResult{}
...
type versionServiceProcessorGetCloud struct {
	handler VersionService
}

func (p *versionServiceProcessorGetCloud) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VersionServiceGetCloudArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VersionServiceGetCloudResult{}
...
type versionServiceProcessorSetCloud struct {
	handler VersionService
}

func (p *versionServiceProcessorSetCloud) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VersionServiceSetCloudArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VersionServiceSetCloudResult{}
...
type versionServiceProcessorGetDump struct {
	handler VersionService
}

func (p *versionServiceProcessorGetDump) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VersionServiceGetDumpArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VersionServiceGetDumpResult{}
...
type versionServiceProcessorAndroidGetVersion struct {
	handler VersionService
}

func (p *versionServiceProcessorAndroidGetVersion) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VersionServiceAndroidGetVersionArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("AndroidGetVersion", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VersionServiceAndroidGetVersionResult{}
	var retval *AndroidGetVersionResponse
	if retval, err2 = p.handler.AndroidGetVersion(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing AndroidGetVersion: "+err2.Error())
		oprot.WriteMessageBegin("AndroidGetVersion", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("AndroidGetVersion", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type VersionServiceGetTestArgs struct {
	Req *GetTestRequest `thrift:"req,1"`
}
...
type VersionServiceAndroidGetVersionArgs struct {
	Req *AndroidGetVersioneRequest `thrift:"req,1"`
}
...
type VersionServiceAndroidGetVersionResult struct {
	Success *AndroidGetVersionResponse `thrift:"success,0,optional"`
}
...
func NewCommonServiceProcessor(handler CommonService) *CommonServiceProcessor {
	...
	self.AddToProcessorMap("GetCSS", &commonServiceProcessorGetCSS{handler: handler})
	self.AddToProcessorMap("GetHtml", &commonServiceProcessorGetHtml{handler: handler})
	self.AddToProcessorMap("GetUserAgreement", &commonServiceProcessorGetUserAgreement{handler: handler})
	self.AddToProcessorMap("GetTermsList", &commonServiceProcessorGetTermsList{handler: handler})
	self.AddToProcessorMap("GetTerm", &commonServiceProcessorGetTerm{handler: handler})
	self.AddToProcessorMap("GetNotice", &commonServiceProcessorGetNotice{handler: handler})
	return self
}
...
type commonServiceProcessorGetCSS struct {
	handler CommonService
}

func (p *commonServiceProcessorGetCSS) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := CommonServiceGetCSSArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := CommonServiceGetCSSResult{}
...
type commonServiceProcessorGetHtml struct {
	handler CommonService
}

func (p *commonServiceProcessorGetHtml) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := CommonServiceGetHtmlArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := CommonServiceGetHtmlResult{}
...
type commonServiceProcessorGetUserAgreement struct {
	handler CommonService
}

func (p *commonServiceProcessorGetUserAgreement) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := CommonServiceGetUserAgreementArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := CommonServiceGetUserAgreementResult{}
...
type commonServiceProcessorGetTermsList struct {
	handler CommonService
}

func (p *commonServiceProcessorGetTermsList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := CommonServiceGetTermsListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := CommonServiceGetTermsListResult{}
...
type commonServiceProcessorGetTerm struct {
	handler CommonService
}

func (p *commonServiceProcessorGetTerm) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := CommonServiceGetTermArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := CommonServiceGetTermResult{}
...
type commonServiceProcessorGetNotice struct {
	handler CommonService
}

func (p *commonServiceProcessorGetNotice) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := CommonServiceGetNoticeArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("GetNotice", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := CommonServiceGetNoticeResult{}
	var retval *GetNoticeResponse
	if retval, err2 = p.handler.GetNotice(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing GetNotice: "+err2.Error())
		oprot.WriteMessageBegin("GetNotice", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("GetNotice", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type CommonServiceGetNoticeArgs struct {
	Req *GetNoticeRequst `thrift:"req,1"`
}
...
func (p *CommonServiceGetNoticeArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CommonServiceGetNoticeArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CommonServiceGetNoticeArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *CommonServiceGetNoticeArgs) Write(oprot thrift.TProtocol) (err error) {

	var fieldId int16
	if err = oprot.WriteStructBegin("GetNotice_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *CommonServiceGetNoticeArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
type CommonServiceGetNoticeResult struct {
	Success *GetNoticeResponse `thrift:"success,0,optional"`
}
...
func (p *CommonServiceGetNoticeResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CommonServiceGetNoticeResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CommonServiceGetNoticeResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *CommonServiceGetNoticeResult) Write(oprot thrift.TProtocol) (err error) {

	var fieldId int16
	if err = oprot.WriteStructBegin("GetNotice_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *CommonServiceGetNoticeResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
