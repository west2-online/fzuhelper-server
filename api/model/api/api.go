...
func NewAuthMeRequest() *AuthMeRequest {
	return &AuthMeRequest{}
}

func (p *AuthMeRequest) InitDefault() {
}

func (p *AuthMeRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("AuthMeRequest(%+v)", *p)
}

type AuthMeResponse struct {
	AdminID *string `thrift:"adminID,1,optional" form:"adminID" json:"adminID,omitempty" query:"adminID"`
}

func NewAuthMeResponse() *AuthMeResponse {
	return &AuthMeResponse{}
}

func (p *AuthMeResponse) InitDefault() {
}

var AuthMeResponse_AdminID_DEFAULT string

func (p *AuthMeResponse) GetAdminID() (v string) {
	if !p.IsSetAdminID() {
		return AuthMeResponse_AdminID_DEFAULT
	}
	return *p.AdminID
}

func (p *AuthMeResponse) IsSetAdminID() bool {
	return p.AdminID != nil
}

func (p *AuthMeResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("AuthMeResponse(%+v)", *p)
}

type SSOLoginRequest struct {
	ReturnTo string `thrift:"returnTo,1,required" form:"returnTo,required" json:"returnTo,required" query:"returnTo,required"`
}

func NewSSOLoginRequest() *SSOLoginRequest {
	return &SSOLoginRequest{}
}

func (p *SSOLoginRequest) InitDefault() {
}

func (p *SSOLoginRequest) GetReturnTo() (v string) {
	return p.ReturnTo
}

func (p *SSOLoginRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SSOLoginRequest(%+v)", *p)
}

type SSOLoginResponse struct {
}

func NewSSOLoginResponse() *SSOLoginResponse {
	return &SSOLoginResponse{}
}

func (p *SSOLoginResponse) InitDefault() {
}

func (p *SSOLoginResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SSOLoginResponse(%+v)", *p)
}
...
func NewExchangeRequest() *ExchangeRequest {
	return &ExchangeRequest{}
}

func (p *ExchangeRequest) InitDefault() {
}

func (p *ExchangeRequest) GetTicket() (v string) {
	return p.Ticket
}

func (p *ExchangeRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ExchangeRequest(%+v)", *p)
}

type ExchangeResponse struct {
	AccessToken *string `thrift:"accessToken,1,optional" form:"accessToken" json:"accessToken,omitempty" query:"accessToken"`
}

func NewExchangeResponse() *ExchangeResponse {
	return &ExchangeResponse{}
}

func (p *ExchangeResponse) InitDefault() {
}

var ExchangeResponse_AccessToken_DEFAULT string

func (p *ExchangeResponse) GetAccessToken() (v string) {
	if !p.IsSetAccessToken() {
		return ExchangeResponse_AccessToken_DEFAULT
	}
	return *p.AccessToken
}

func (p *ExchangeResponse) IsSetAccessToken() bool {
	return p.AccessToken != nil
}

func (p *ExchangeResponse) String() string {
	if p == nil {
		return "<nil>"
	}
...
type AdminService interface {
	// 查询登录用户
	AuthMe(ctx context.Context, req *AuthMeRequest) (r *AuthMeResponse, err error)
	// 发起统一登录平台授权
	SSOLogin(ctx context.Context, req *SSOLoginRequest) (r *SSOLoginResponse, err error)
	// 回调
