...
type GetUserInfoResponse struct {
	...
	Data *UserInfo       `thrift:"data,2,optional" form:"data" json:"data,omitempty" query:"data"`
}
...
var GetUserInfoResponse_Data_DEFAULT *UserInfo

func (p *GetUserInfoResponse) GetData() (v *UserInfo) {
	if !p.IsSetData() {
