...
type CourseListResponse struct {
	...
	CustomCourses []*model.CustomCourse `thrift:"custom_courses,3,optional,list<model.CustomCourse>" form:"custom_courses" json:"custom_courses,omitempty" query:"custom_courses"`
}
...
var CourseListResponse_CustomCourses_DEFAULT []*model.CustomCourse

func (p *CourseListResponse) GetCustomCourses() (v []*model.CustomCourse) {
...
type CourseListV2Response struct {
	Base          *model.BaseResp       `thrift:"base,1,required" form:"base,required" json:"base,required" query:"base,required"`
	Data          []*model.Course       `thrift:"data,2,required,list<model.Course>" form:"data,required" json:"data,required" query:"data,required"`
	CustomCourses []*model.CustomCourse `thrift:"custom_courses,3,required,list<model.CustomCourse>" form:"custom_courses,required" json:"custom_courses,required" query:"custom_courses,required"`
}
...
func (p *CourseListV2Response) GetCustomCourses() (v []*model.CustomCourse) {
	return p.CustomCourses
}
...
type UpsertCustomCourseRequest struct {
	Term   string              `thrift:"term,1,required" form:"term,required" json:"term,required" query:"term,required"`
	Course *model.CustomCourse `thrift:"course,2,required" form:"course,required" json:"course,required" query:"course,required"`
}
...
var UpsertCustomCourseRequest_Course_DEFAULT *model.CustomCourse

func (p *UpsertCustomCourseRequest) GetCourse() (v *model.CustomCourse) {
	if !p.IsSetCourse() {
...
type DeleteCustomCourseRequest struct {
	CourseID string `thrift:"course_id,1,required" form:"course_id,required" json:"course_id,required" query:"course_id,required"`
}
